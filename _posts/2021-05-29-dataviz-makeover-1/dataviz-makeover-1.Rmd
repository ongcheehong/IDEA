...
The completed data visualization using tableau desktop can be accessed through [**here**](https://public.tableau.com/app/profile/chee.hong/viz/Singaporestop6merchandisetradingpartners2019-2020/Dashboard1). Do note to select full screen to have better visibility of the chart.
...
14(a) Do note that the above visualisation is not finalized. The reason being that there is some disorientation when the dashboard is published in Tableau Public. See below for the disoriented dashboard in Tableau Public.

![](img/Disoriented Dashboard.png)

15. As such we will make some changes to the dashboard. 1) Remove the marker to indicate the month of interest. 2) The annotation will be change to area type instead of mark type. The finalized visualisation is as shown below.

![](img/Final Dashboard_2.png)


16. The visualisation can be assessed from this [**link**](https://public.tableau.com/app/profile/chee.hong/viz/Singaporestop6merchandisetradingpartners2019-2020/Dashboard1). Do note that there will be some minor differences between the visualisation from Tableau Desktop and Tableau Public due to the difference in aspect ratio etc.
